      ...
      <CardContent className="space-y-2">
        ...
        <div className="flex gap-4 items-center">
          <div className="flex items-center gap-1">
            <Heart className="h-4 w-4 lg:h-6 lg:w-6 text-primary/75" />
            <p className="text-sm lg:text-base font-normal text-primary/75">
          ...
          <div className="flex items-center gap-1">
            <MessageCircle className="h-4 w-4 lg:h-6 lg:w-6 text-primary/75" />
            <p className="text-sm lg:text-base font-normal text-primary/75">
